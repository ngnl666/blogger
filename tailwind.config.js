  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        card: theme.colors.default.theme_color.card,
        ...
        darkmode: {
          ...
          card: theme.colors.darkmode.theme_color.card,
      ...
      fontFamily: {
        primary: [fontPrimary, fontPrimaryType, fontTertiary, fontTertiaryType],
        secondary: [
          fontSecondary,
          fontSecondaryType,
          fontTertiary,
